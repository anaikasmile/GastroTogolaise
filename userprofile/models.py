...
class Profile(models.Model):
	...
	linkedin = models.CharField(max_length=250, verbose_name=_(u'lindkedin'), blank=True, help_text=_(u'linkedin ID'))
	facebook = models.CharField(max_length=250, verbose_name=_(u'Facebook'), blank=True, help_text=_(u'facebook ID'))
	twitter = models.CharField(max_length=250, verbose_name=_(u'Twitter'), blank=True, help_text=_(u'Twitter ID'))
	gplus = models.CharField(max_length=250, verbose_name=_(u'Google plus'), blank=True, help_text=_(u'Google plus ID'))
	instagram = models.CharField(max_length=250, verbose_name=_(u'Instagram'), blank=True, help_text=_(u'Instagram ID'))
